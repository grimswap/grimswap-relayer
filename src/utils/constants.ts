...
export const CONTRACTS = {
  ...
  GRIM_POOL: process.env.GRIM_POOL_ADDRESS || "0x6777cfe2A72669dA5a8087181e42CA3dB29e7710",
  GRIM_SWAP_ZK: process.env.GRIM_SWAP_ZK_ADDRESS || "0x3bee7D1A5914d1ccD34D2a2d00C359D0746400C4", // fee=3000, tickSpacing=60
  GRIM_SWAP_ROUTER: process.env.GRIM_SWAP_ROUTER_ADDRESS || "0x5EE78E89A0d5B4669b05aC8B7D7ea054a08f555f",
